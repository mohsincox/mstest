				...
				<!-- <form class="login100-form validate-form" action="{{ route('login') }}" method="post"> -->
					...
					<div class="text-center p-t-50">
			            <span class="txt1">
			              ...
			              Don’t have account? <a style="font-weight: 400; color: #313AEB; text-decoration: none; border-bottom: 1px dotted #313AEB;" class="txt2" href="{{ url('/register') }}"><b>&nbsp;Sign Up&nbsp;</b></a>
			            </span>
